...
<section class="pricing-plans content-block">
  <h2>Plans for every size of business</h2>
  <article class="plans grid lg:flex gap-8 justify-between w-full">
    <div class="plan plan1">
      <svg
        ...
        style="enable-background:new 0 0 116.28 122.88"
        xml:space="preserve"
        ><style type="text/css">
          .st0 {
            fill-rule: evenodd;
      ...
      <span class="font-bold text-[--color-primary]">Contact for pricing</span>
      <p>
        Custom code, great performance, impeccable design. What more could you
        want?
      </p>
      <ul>
        <li class="plan-item">Logo design</li>
        <li class="plan-item">Facebook banner</li>
        <li class="plan-item">Business cards</li>
        <li class="plan-item">Social media posts</li>
        <li class="plan-item">Postcards</li>
        <li class="plan-item">Review cards</li>
        <li class="plan-item">Door hangers</li>
        <li class="plan-item">Car wraps</li>
      </ul>
    </div>
    <div class="plan plan2 most-popular">
      <svg
        width="50px"
        version="1.1"
        id="Layer_1"
        ...
        x="0px"
        y="0px"
        viewBox="0 0 108.19 122.88"
        style="enable-background:new 0 0 108.19 122.88"
        xml:space="preserve"
        ><style type="text/css">
          .st0 {
            fill-rule: evenodd;
    ...
    <div class="plan plan3">
      <svg
        ...
        style="enable-background:new 0 0 122.88 101.57"
        xml:space="preserve"
        ><g
          ><path
      ...
      <span class="font-bold text-[--color-primary]">+$150/ Month</span>
      <p>
        Custom code, great performance, impeccable design. What more could you
        want?
      </p>
      <ul>
        <li class="plan-item">Website hosting</li>
        <li class="plan-item">Wicked fast</li>
        <li class="plan-item">100% Custom Code</li>
        <li class="plan-item">Ongoing support</li>
        <li class="plan-item">Google friendly</li>
        <li class="plan-item">Mobile friendly</li>
      </ul>
    </div>
  </article>
  <div class="content-block">
    <h3>Need a custom plan?</h3>
    <p>Get in touch with us, we guarantee we can work something out.</p>
    <Email btn text="Get started!" />
  </div>
</section>
